...
class UserRegisterForm(forms.Form):
    ...
    genero = forms.ModelChoiceField(Genero, label='Genero:', widget=forms.Select(), required=False)
    ...
    rg = forms.CharField(label='RG:', max_length=12, required=False)
    orgaoemissor = forms.CharField(label='Orgão Emissor:', max_length=45, required=False)
...
class CompanyRegisterForm(forms.Form):
    ...
    ie = forms.CharField(label='Inscrição Estadual', max_length=45, required=False)
    ...
    # FIELDS ENDERECO
    numeroed = forms.IntegerField(label='Numero:', required=False)
    complemento = forms.CharField(label='Complemento:', max_length=45, required=False)
    pontoreferencia = forms.CharField(label='Ponto de referência:', max_length=45, widget=forms.Textarea, required=False)
